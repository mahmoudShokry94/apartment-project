...
var ApartmentRepository = __importStar(require("../repositories/apartments"));
var getApartments = function (_a) {
    var pageIndex = _a.pageIndex, pageSize = _a.pageSize, projectName = _a.projectName;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            console.log("Service...getApartments...");
            return [2 /*return*/, ApartmentRepository.getApartments({
...
var insertApartment = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, ApartmentRepository.insertApartment(payload)];
    });
}); };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, ApartmentRepository.getApartmentById(id)];
            case 1:
                apartment = _a.sent();
                if (!apartment) {
                    throw new error_1.NotFoundError("Apartment not found");
                }
                return [2 /*return*/, apartment];
        }
    });
}); };
